            ...
            <CSSTransition classNames="fade" timeout={500}>
              <div className="my-intro">
                <p className="about-me">
                  ...
                  transition into a full-time role in the tech industry, where I
                  can combine my legal background and coding skills to create
                  innovative solutions.
                  <br />
                  <br />
                  I'm driven by a desire to make a positive impact through
                  technology and continuously expand my knowledge in the field.
                  In my free time, I enjoy exploring new technologies, attending
                  tech meetups, and engaging in coding challenges. <br />
                  I'm excited about the future and the endless possibilities in
